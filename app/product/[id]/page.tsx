...
export default async function ProductPage({ params }: ProductPageProps) {
  try {
    console.log(`Ürün detay sayfası yükleniyor. ID: ${params.id}`)
    ...
    console.log(`Ürün başarıyla yüklendi: ${product.name}`)

    // İlgili ürünleri çek (hata olursa boş array döner)
    const relatedProducts = await getRelatedProducts(product.id, product.categorySlug || product.category_slug, 4)
    ...
    console.error("❌ Ürün detay sayfası yüklenirken hata:", error)
    throw error
  }
}
